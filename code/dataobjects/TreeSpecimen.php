...
class TreeSpecimen extends DataObject
{
    ...
    public function getFrontEndFields($params = NULL)
    {
        ...
        $fields->add(LiteralField::create('Show on map', '<a class="btn float-none" href="'.BotanicalMappingController::$controllerPath.'/'.$this->ClassName.'/map/'.$this->ID.'">Show this specimen on map</a>'));
